...
public class Trsdata_Fb74_Nisl {
	...
	public void series_set() throws InterruptedException
	{
		...
		driver.switchTo().defaultContent();
    	 ...
    	 try {
 		    WebElement MTB_10 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//table[@class='cdk-table nb-tree-grid']//tr[49]//td[3]")));
 		    MTB_10.click();
 		    System.out.println("FTB-74 clicked successfully.");
 		    Thread.sleep(2000);
 		} catch (Exception e) {
 		    System.out.println(" FTB-74 not clicked: " + e.getMessage());
 		}
    	 ...
    	 try {
  		    WebElement section = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[text()='1'])[1]")));
  		    section.click();
	...
	private void nextSection() {
		...
		WebElement nextSectionButton = driver.findElement(By.xpath("//i[@class='fas fa-arrow-right']"));
		clickElementWithRetry(nextSectionButton, "Next Section");
	}
